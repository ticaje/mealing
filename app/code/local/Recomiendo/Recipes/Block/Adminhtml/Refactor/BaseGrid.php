 ...
 */
class Recomiendo_Recipes_Block_Adminhtml_Refactor_BaseGrid extends Mage_Adminhtml_Block_Widget_Grid
{
     ...
     *
     * @return Recomiendo_Recipes_Block_Adminhtml_Refactor_BaseGrid
     */
        ...
        $this->addColumn('action',
            array(
                ...
                'actions'   => array(array(
                    ...
                    'field'   => 'id',
                    'confirm' =>  Mage::helper('recomiendo_recipes')->__('Esta seguro?')
                )),
                'filter'    => false,
                'sortable'  => false,
                'index'     => 'recipes',
