<?php
/**
 * Ingredients List admin edit form content tab
 *
 * @author Hector Luis Barrientos Margolles
 */
class Recomiendo_Recipes_Block_Adminhtml_Ingredients_Edit_Tab_Content
    ...
    implements Mage_Adminhtml_Block_Widget_Tab_Interface
{
     ...
     *
     * @return Recomiendo_Ingredients_Block_Adminhtml_Ingredients_Edit_Tab_Content
     */
    ...
    protected function _prepareForm()
    {
        ...
        Mage::dispatchEvent('adminhtml_ingredients_edit_tab_content_prepare_form', array('form' => $form));
