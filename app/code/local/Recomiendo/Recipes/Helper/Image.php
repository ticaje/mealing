 ...
 *
 */
class Recomiendo_Recipes_Helper_Image extends Mage_Core_Helper_Abstract
{
    /**
    ...
    /**
     * Return the base media directory for Recipe Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Recipe Item images
     *
     * @return string
     */
    ...
    /**
     * Remove recipes item image by image filename
     *
    ...
    public function uploadImage($scope)
    {
        ...
        if ($adapter->isUploaded($scope)) {
            ...
            if (!$adapter->isValid($scope)) {
                Mage::throwException(Mage::helper('recomiendo_recipes')->__('Uploaded image is not valid'));
            }
    ...
    /**
     * Return URL for resized Recipe Item Image
     *
     * @param Recomiendo_Recipes_Model_Item $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(Recomiendo_Recipes_Model_Recipe $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
