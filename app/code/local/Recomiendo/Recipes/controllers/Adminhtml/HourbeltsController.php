<?php
/*
 * Hourbelts admin controller
 *
 * @author Hector Luis Barrientos Margolles
 *
 */
class Recomiendo_Recipes_Adminhtml_HourbeltsController extends Recomiendo_Recipes_Controller_Adminhtml_Codifier_BaseController
{
