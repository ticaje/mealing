<?php
/*
 * Utils admin controller
 *
 * @author Hector Luis Barrientos Margolles
 *
 */
class Recomiendo_Recipes_Adminhtml_UtilsController extends Recomiendo_Recipes_Controller_Adminhtml_Codifier_BaseController
{

  /* Define general variables based on refactoring */
  protected $_currentEntity          = "Utensilios";
  protected $_currentEntityModelName = "recomiendo_recipes/codifier_util";
  protected $_titleLabel             = "Utensilio";
  protected $_registeringEntityName  = "utils_item";
  protected $_getParamId             = "util_id";
