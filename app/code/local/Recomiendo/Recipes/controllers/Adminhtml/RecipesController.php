 ...
 *
 */
class Recomiendo_Recipes_Adminhtml_RecipesController extends Mage_Adminhtml_Controller_Action
{
  ...
  protected function _initAction()
  {
    ...
    $this->loadLayout()
      ...
      ->_addBreadcrumb(
        Mage::helper('recomiendo_recipes')->__('Recipes'),
        Mage::helper('recomiendo_recipes')->__('Recipes')
      )
      ->_addBreadcrumb(
        Mage::helper('recomiendo_recipes')->__('Manage Recipes'),
        Mage::helper('recomiendo_recipes')->__('Manage Recipes')
      )
      ;
    return $this;
    ...
    if ($recipeId) {
      ...
      if (!$model->getId()) {
        $this->_getSession()->addError(
          Mage::helper('recomiendo_recipes')->__('Recipes item does not exist.')
        );
  ...
  public function saveAction()
  {
    ...
    if ($data) {
      ...
      try {
        ...
        $imageHelper = Mage::helper('recomiendo_recipes/image');
        // remove image
        ...
        $this->_getSession()->addSuccess(
          Mage::helper('recomiendo_recipes')->__('The recipes item has been saved.')
        );
        ...
        $this->_getSession()->addException($e,
          Mage::helper('recomiendo_recipes')->__('An error occurred while saving the recipes item.')
        );
      }
