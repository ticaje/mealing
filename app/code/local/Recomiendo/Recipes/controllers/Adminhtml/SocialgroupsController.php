<?php
/*
 * Socialgroups admin controller
 *
 * @author Hector Luis Barrientos Margolles
 *
 */
class Recomiendo_Recipes_Adminhtml_SocialgroupsController extends Recomiendo_Recipes_Controller_Adminhtml_Codifier_BaseController
{

  /* Define general variables based on refactoring */
  protected $_currentEntity          = "Grupos Sociales";
  protected $_currentEntityModelName = "recomiendo_recipes/codifier_socialgroup";
  protected $_titleLabel             = "Grupo Social";
  protected $_registeringEntityName  = "socialgroups_item";
  protected $_getParamId             = "socialgroup_id";
