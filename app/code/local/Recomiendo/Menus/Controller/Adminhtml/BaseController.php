 ...
 *
 */
class Recomiendo_Menus_Controller_Adminhtml_BaseController extends Mage_Adminhtml_Controller_Action
{
  ...
  public function saveAction()
  {
    ...
    if ($data) {
      ...
      $model->addData($data);
      $_active_tab    = $this->getRequest()->getParam('active_tab');
      //print_r($model); exit;
      try {
        $hasError = false;
        // save the data
        ...
        if ($this->getRequest()->getParam('back')) {
          $redirectPath   = '*/*/edit';
          $redirectParams = array('id' => $model->getId(), 'active_tab' => $_active_tab);
        }
      ...
      if ($hasError) {
        ...
        $redirectPath   = '*/*/edit';
        $redirectParams = array('id' => $this->getRequest()->getParam('id'), 'active_tab' => $_active_tab);
      }
    }
