...
class Recomiendo_Menus_Block_Adminhtml_Tabs_Dinnermenu extends Mage_Adminhtml_Block_Widget_Grid
{
  /**
   * Set grid params
   *
  ...
  {
    parent::__construct();
    $this->setId('dinner_recipes_grid');
  ...
  protected function _prepareColumns()
  {
    if (!$this->isReadonly()) {
      $this->addColumn('in_products', array(
        ...
        'align'             => 'center',
        'index'             => 'recipe_id',
        'field_name'        => 'selectedDinnerRecipes[]'
      ));
    }
  ...
  public function getGridUrl()
  {
    return $this->getData('grid_url')
      ...
      : $this->getUrl('*/*/dinnerGrid', array('_current' => true));
  }
  ...
  public function getSelectedRelatedRecipes()
  {
    ...
    foreach ($instance->getRelatedRecipes(false) as $recipe_id) {
